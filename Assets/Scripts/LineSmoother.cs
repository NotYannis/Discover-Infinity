...
public class LineSmoother : MonoBehaviour
{
    public static Vector3[] SmoothLine(Vector3[] inputPoints, float segmentSize)
    {
        ...
        //for(int i = inputPoints.Length - 1; i < inputPoints.Length + 2; ++i)
        //{
        //    int j = i % (inputPoints.Length);
        //    float distanceToNext;
        //    print(j);
        //    if(j < inputPoints.Length - 1)
        //    {
        //        distanceToNext = Vector3.Distance(inputPoints[j], inputPoints[j + 1]);
        //    }
        //    else
        //    {
        //        distanceToNext = Vector3.Distance(inputPoints[j], inputPoints[0]);
        //    }
        ...
        //        //sample curves to find smoothed position
        //        lineSegments[j] = new Vector3(curveX.Evaluate(time), curveY.Evaluate(time), curveZ.Evaluate(time));
        //    }
        //}
